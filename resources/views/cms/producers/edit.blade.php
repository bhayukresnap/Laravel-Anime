...
<form id="update" action="{{route('cms.producers.update', $producer->id)}}">
  <div class="page-header">
    <div class="demo-nav-title">
      <div class="media">
        <div class="media-body">
          <div class="display-6">Update producer - {{$producer->name}}</div>
      ...
      <div class="panel">
        <div class="panel-body">
          <div class="row">
            ...
            @include('cms.template.meta', ['meta'=>$producer->meta])
