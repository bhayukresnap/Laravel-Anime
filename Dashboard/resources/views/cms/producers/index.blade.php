  ...
  <div class="demo-nav-title">
    <div class="media">
      <div class="media-body">
        <div class="display-6">Producers</div>
    ...
    <div class="pull-xs-right" role="toolbar">
      <a href="{{route('cms.producers.create')}}" class="btn btn-success" type="button">Add Data</a>
    </div>
  </div>
</div>
...
<div class="container-fluid">
  <div class="panel-wrapper">
    <div class="panel">
          ...
          <tbody>
            @foreach($producers as $producer)
              <tr>
                ...
                <td>
                  <a class="btn btn-primary" href="{{route('cms.producers.edit', $producer->id)}}">
                    <i class="icon ion-edit"></i>
                  </a>
                  <form method="POST" action="{{route('cms.producers.destroy', $producer->id)}}">
                    @csrf
                    {{method_field('DELETE')}}
      ...
      <div class="table-bar">
        {{ $producers->appends(request()->input())->onEachSide(1)->links('vendor.pagination.bootstrap-4') }}
      </div>
    </div>
  </div>
</div>
